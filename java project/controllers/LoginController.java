...
public class LoginController implements Initializable {
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        ...
        userNotFoundError.managedProperty().bind(userNotFoundError.visibleProperty()); // remove the area if invisible
        passwordError.managedProperty().bind(passwordError.visibleProperty()); // remove the area if invisible
